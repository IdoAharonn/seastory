...
-תוסיף איקס לכל מוצר וכשלוחצים עליו המוצר נמחק 
*/

// לסיים בריאקט את המחיקת פריט 
// ללמוד בנוד י=גי אס איך יצור אותה אפליקציה עם אקספרס ושימוש לפוסטמן דרך וובסרביסס
